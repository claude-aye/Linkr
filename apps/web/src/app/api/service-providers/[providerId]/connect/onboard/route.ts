...
/**
 * BFF Stripe Connect onboarding proxy — starts (or resumes) Express
 * onboarding and returns a single-use Account Link.
 *
 * `POST /api/service-providers/{providerId}/connect/onboard` →
 * `POST /service-providers/{id}/connect/onboard`. Authenticated server-side by the
