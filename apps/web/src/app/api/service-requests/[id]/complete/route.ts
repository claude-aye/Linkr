...
/**
 * BFF complete proxy (Phase B — provider dashboard transitions).
 *
 * `POST /api/service-requests/{id}/complete` → `POST /service-requests/{id}/complete`.
 ...
 * FR message mapping lives client-side (PR 2). It never logs the token.
 */
